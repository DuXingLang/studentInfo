...
<body>
<%
	ArrayList sclist = (ArrayList) session.getAttribute("sclist");	
%>
    ...
    <div class="contain">
        ...
        <ul>
            ...
            <li class="liselected"><a href="getSC.jsp">查询选课信息</a></li>
    ...
    <div class="main">
        <div class="row">
        	<form action="getSC.jsp?type=select" method="post">
...
%>
			<tr>
				...
				<td><a href="doSC.jsp?type=delete&stuId=<%=single.getStuId()%>&courseId=<%=single.getCourseId()%>">删除</a></td>
			</tr>
<%
			}
		}
